...
const paths: Record<string, string> = {
  ...
  today:
    '<rect x="4" y="4" width="16" height="17" rx="3"/><path d="M8 2v4m8-4v4M4 10h16m-12 5 3 3 5-5"/>',
  cal: '<rect x="3" y="5" width="18" height="16" rx="3"/><path d="M7 3v4m10-4v4M3 11h18M8 15h1m6 0h1m-8 3h1"/>',
  routes:
    '<path d="M6 20c-7-7 8-6 4-12S19 0 19 6s-8 6-4 12"/><circle cx="6" cy="20" r="2"/><circle cx="15" cy="19" r="2"/>',
